...
import 'package:blue_medical_clinic/modules/user.type.screens/patient_screens/doctors.list/CoronaSection.dart';
                            ...
                            children: _sectionList.map((item) => Card(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  ...
                                  if(_sectionList.indexOf(item)==5)
                                  {
                                    navigateTo( CoronaSection(), context);
                                  }
                                },
                                child: Container(
                                  decoration: BoxDecoration(
