...
class PsychologicalSection extends StatelessWidget {

  List doctor =[];
  CollectionReference docRefPsychological    = FirebaseFirestore.instance.collection('Section').doc('Doctors').collection('Psychological');

  PsychologicalSection({Key? key}) : super(key: key);
  @override
                        ...
                        child: Padding(
                          ...
                          child: Material(
                            ...
                            child: Container(
                              ...
                              child: FutureBuilder(
                                future: docRefPsychological.get(),
