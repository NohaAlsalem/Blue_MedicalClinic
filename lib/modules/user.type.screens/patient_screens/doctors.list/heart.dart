...
class HeartSection extends StatelessWidget {
  ...
  List doctor =[];
  CollectionReference docRefHeart = FirebaseFirestore.instance.collection('Section').doc('Doctors').collection('heart');

  HeartSection({Key? key}) : super(key: key);
  @override
